...
@section('content')
<div class="bg-gray-900 text-gray-100 px-8 py-12">
      ...
      <div
        ...
        <div class="flex flex-col justify-between">
          <div>
            ...
            <div class="text-gray-700 mt-8">
              Hate forms? Send us an <span class="underline text-blue-600"><a href="https://mail.google.com/mail/u/0/?fs=1&to=tahmidrahman.170121@s.pust.ac.bd&tf=cm" target="_blank">Email</a></span> instead.
            </div>
          </div>
        ...
        <form class="" action="{{ route('contact.store') }}" method="POST">
            ...
            <div class="mt-8">
	            ...
	            <textarea class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" name="msg" required></textarea>
            </div>
            <div class="mt-8">
	            <button
