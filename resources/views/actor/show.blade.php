                ...
                @foreach ($movie['cast'] as $cast)
                    <div class="mt-8">
                        <a href="#">
                            ...
                            @endif -->
                            <img src="{{ $cast['profile_path'] ? 'https://image.tmdb.org/t/p/w300/'.$cast['profile_path'] : 'https://ui-avatars.com/api/?size=128&name='. $cast['name'] }}" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <div class="mt-2">
