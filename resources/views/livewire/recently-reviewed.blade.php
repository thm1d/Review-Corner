<div wire:init="loadRecentlyReviewed" wire:loading.class="animate-pulse" class="popular-games text-sm grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-5 gap-12 border-b border-gray-800 pb-16 ">
