...
<div class="container mx-auto mb-4">
	<div class="your-ratings-container mx-0 md:mx-0 sm:mx-0 lg:mx-40 xl:mx-40 border-2 border-t-0 border-gray-600 h-auto min-h-screen text-white">
		<div class="mx-4 my-4 border border-opacity-25 border-gray-600 rounded-lg min-h-screen">
			<h2 class="uppercase tracking-wider text-orange-500 text-lg font-semibold ml-4 mt-4 px-2 py-4">Your Wachlist</h2>
						...
						<div class="flex items-center">
							...
							<div class="desc mx-8">
								...
								<div class="mt-4 flex flex-row">
			                        ...
			                        <span class="ml-1 mr-2">{{ $movie['imdbRating'] }}</span>
			                    </div>
			                    <span class="mt-2 text-sm font-light">Rated on 01 Nov, 2021</span>
